...
print(paste("Beta1 Corr / Uncorr:", round(0.141 / 0.0614,4) ))

print(paste("Beta2 Corr / Uncorr:", round(0.142 / 0.062,4) ))

mean(c(1.82, 2.76, 1.74))

```

It seems that the beta 1 and beta 2 ratios are very close to the VIF values we calculated. They seem to be close to the weighted average of the VIFs.
